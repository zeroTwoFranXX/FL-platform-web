...
import { RemoveCenterData, QueryCenterDatas } from '@/services/center-data-management'
import ShowCenterDataDetial from './components/showCenterDataDetail'
import AuthorizedPersonList from './components/authorizedPersonList'
export default {
    name: 'index.vue',
    components: {
    ...
    methods: {
        ...
        // 请求中央数据集列表
        queryList () {
            QueryCenterDatas({ ...this.searchParams }).then((response) => {
