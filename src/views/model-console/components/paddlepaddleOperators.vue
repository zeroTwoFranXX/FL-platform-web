<template>
    <div class="paddleContainer">
        <p style="margin: 10px 0 0 36px;font-weight: bold;font-size: 15px">paddlepaddle算子</p>
...
.paddleContainer /deep/ .el-tree-node__content{
    height: 38px;
}
.middle{
    margin-left: 55px;
